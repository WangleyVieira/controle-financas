...
class LancamentoRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'tipo_categoria_id' => ['nullable', 'integer', 'exists:tipo_categorias,id'],
            'data_vencimento' => ['required', 'date'],
            'dia_pagamento' => ['nullable', 'integer', 'between:1,31'],
            'is_pago' => ['nullable', 'boolean'],
            'data_pagamento' => ['nullable', 'date'],
            'responsavel' => ['required', 'in:deborah,wangley,casal'],
    ...
    public function messages()
    {
        return [
            ...
            'responsavel.required' => 'Responsavel e obrigatorio.',
            'responsavel.in' => 'Responsavel invalido.',
